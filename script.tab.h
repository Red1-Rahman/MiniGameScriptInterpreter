...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    STRING = 267,                  /* STRING  */
    DIRECTION = 268,               /* DIRECTION  */
    OPERATOR = 269,                /* OPERATOR  */
    REPEAT = 270,                  /* REPEAT  */
    ENDREPEAT = 271,               /* ENDREPEAT  */
    PLACE = 272,                   /* PLACE  */
    OBJECT_TYPE = 273,             /* OBJECT_TYPE  */
    ARITHOP = 274,                 /* ARITHOP  */
    GRIDSIZE = 275,                /* GRIDSIZE  */
    HEALTH = 276,                  /* HEALTH  */
    INVENTORY = 277,               /* INVENTORY  */
    USE = 278,                     /* USE  */
    RANDOM = 279,                  /* RANDOM  */
    SOUND = 280,                   /* SOUND  */
    WAIT = 281,                    /* WAIT  */
    TELEPORT = 282,                /* TELEPORT  */
    STATUS = 283,                  /* STATUS  */
    ATTACK = 284,                  /* ATTACK  */
    MISSION = 285,                 /* MISSION  */
    GENERATE = 286,                /* GENERATE  */
    THEME = 287,                   /* THEME  */
